...
class ModelTest2(unittest.TestCase):
    ...
    def test_vertices(self):
        ...
        self.assertEqual(ModelTest2.cn.vertices(),{'v1','v2', 'v3','v4','v5','v6'})
        self.assertEqual(ModelTest2.cn.vertices(),{'v1','v1','v2', 'v3','v4','v5','v6'})
        ...
        with self.assertRaises(EntityNotFound):
            ModelTest2.cn.vertices('Unknown_hedge')
        self.assertEqual(len(ModelTest2.cn.vertices()),len(ModelTest2.cn.participants()))
    
    def test_hyperedges(self):
        self.assertEqual(len(ModelTest2.cn.hyperedges()), 3)
        self.assertEqual(ModelTest2.cn.hyperedges('v1'),{'h1','h3'})
        with self.assertRaises(EntityNotFound):
            ModelTest2.cn.hyperedges('Unknown_vertic')
        self.assertEqual(len(ModelTest2.cn.hyperedges()),len(ModelTest2.cn.channels()))
    

    def test_timings(self):
        self.assertEqual(ModelTest2.cn.timings(),{'h1': 1, 'h2': 2, 'h3': 3})
        self.assertEqual(ModelTest2.cn.timings('h1'), 1)
        with self.assertRaises(KeyError):
            ModelTest2.cn.timings('Unknown_hedge')
